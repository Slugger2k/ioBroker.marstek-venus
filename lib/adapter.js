...
class Adapter {
	...
	async initStates() {
		...
		await this.setObjectNotExistsAsync("battery.chargingAllowed", {
			type: "state",
			common: { name: "Charging allowed", type: "boolean", role: "switch.enable", read: true, write: true },
			native: {},
		});
		await this.setObjectNotExistsAsync("battery.dischargingAllowed", {
			type: "state",
			common: { name: "Discharging allowed", type: "boolean", role: "switch.enable", read: true, write: true },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("power.pv1State", {
			type: "state",
			common: { name: "PV1 state", type: "number", role: "value.state", read: true, write: false },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("power.pv2State", {
			type: "state",
			common: { name: "PV2 state", type: "number", role: "value.state", read: true, write: false },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("power.pv3State", {
			type: "state",
			common: { name: "PV3 state", type: "number", role: "value.state", read: true, write: false },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("power.pv4State", {
			type: "state",
			common: { name: "PV4 state", type: "number", role: "value.state", read: true, write: false },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("control.manualPower", {
			type: "state",
			common: {
				name: "Manual mode power (positive: charge, negative: discharge)",
				type: "number",
				unit: "W",
				role: "level.power",
				min: -3000,
		...
		await this.setObjectNotExistsAsync("network.gateway", {
			type: "state",
			common: { name: "Gateway", type: "string", role: "info.gateway", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("network.mask", {
			type: "state",
			common: { name: "Subnet mask", type: "string", role: "info.mask", read: true, write: false },
			native: {},
		});
		await this.setObjectNotExistsAsync("network.dns", {
			type: "state",
			common: { name: "DNS", type: "string", role: "info.dns", read: true, write: false },
			native: {},
		});
		...
		await this.setObjectNotExistsAsync("energymeter.inputTotal", {
			type: "state",
			common: {
		...
		await this.setObjectNotExistsAsync("energymeter.outputTotal", {
			type: "state",
			common: {
